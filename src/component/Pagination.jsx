    ...
    return (
        <div className="p-3 flex justify-between items-center">
            ...
            <ul className="flex items-center ">
                <li>
                    <a href="!#" onClick={() => setPrev()} className="block mr-2 py-1.5 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <li className="rounded-lg overflow-hidden border w-full border-gray-700 flex justify-between h-full " >
                    {pageNumbers.map(number => (
                        <a key={number} onClick={() => setPageNumbers(number)} href="!#" className={`${currentPage === number ? "" : "dark:bg-gray-800"} w-full py-2 h-full px-3  text-gray-500 bg-white  border-gray-300  hover:text-gray-700  dark:border-gray-700 dark:text-gray-400  dark:hover:text-gray-700`}>{number}</a>
                    ))}
                </li>
                <li>
                    <a href="!#" onClick={() => setNext()} className="block ml-2 py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
